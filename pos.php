                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <!-- <input type="text" name="grand_total" onKeyUp="kalkulatorTambah(getElementById('grand_total').value,this.value);" value="<?php //echo number_format($rowGrandTotal['TOTAL'], 0, ',', '.'); ?>">
 -->
...
<!-- 
                                                                ...
                                                                <div class="form-group">
                                                                <input type="hidden" id="type1" name="grand_total" onKeyUp="kalkulatorTambah(getElementById('type1').value,this.value);"  value="<?php echo number_format($rowGrandTotal['TOTAL'], 0, ',', '.'); ?>" />  
                                                                  
                                                                <input type="text" class="form-control input-lg" id="type2" name="cash" onKeyUp="kalkulatorTambah(getElementById('type1').value,this.value);"   value="<?php echo number_format($rowGrandTotal['TOTAL'], 0, ',', '.'); ?>" />

                                                                   <!--  <input class="form-control input-lg" id="bayar" 
                                                                           name="cash" onKeyUp="kalkulatorTambah(getElementById('grand_total').value,this.value);"
                                                                           value="<?php //echo number_format($rowGrandTotal['TOTAL'], 0, ',', '.'); ?>"
                                                                           type="text""> -->
                                                                </div>
                                                              ...
                                                              <!--       <input type="text" name="Tbayar" id="Tbayar"
